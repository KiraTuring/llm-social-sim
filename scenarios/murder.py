...
class MurderScene(Scene):
    ...
    world_description = (
        "一座偏僻的庄园，昨夜发生了命案。\n"
        "  庄园大厅 → 宽敞的门厅，铺着暗红色地毯，墙上挂着家族画像，连通书房、厨房、花园和警卫室\n"
        "  书房 → 从庄园大厅进入，书架从地板到天花板，书桌上摊着账本和文件\n"
        "  厨房 → 从庄园大厅进入，整洁的厨房，餐具和厨具整齐摆放\n"
        "  花园 → 从庄园大厅进入，通往后山的围墙和大门\n"
        "  警卫室 → 从庄园大厅进入，本地警长在这里临时办公"
    )
...
凶手：庄园主的妻子林夫人（非玩家角色，不在场景内，无法接触或对话）
...
- 场景只有以下 5 个位置：庄园大厅、书房、厨房、花园、警卫室。**没有二楼、没有其他房间**——narrate 内容中也不能出现这些以外的空间
- 场景中只有 3 个人：警长、艾莉娅、雷恩。**没有林夫人、警员、佣人、管家等人物**——narrate 内容中也不能引入 3 人以外的人物
